...
class LearnAdapter( private val context: Context)
    : RecyclerView.Adapter<LearnAdapterViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): LearnAdapterViewHolder {
        val viewHolder =  LearnAdapterViewHolder(CardLearnBinding.inflate(LayoutInflater.from(parent.context),parent,false))
    ...
    override fun onBindViewHolder(holder: LearnAdapterViewHolder, position: Int) {
...
class LearnAdapterViewHolder(private val binding: CardLearnBinding): RecyclerView.ViewHolder(binding.root) {
